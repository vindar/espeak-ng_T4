...
/*************************************************************/
/* Additional method for Teensy for adding voices stored     */
/* in memory (FLASH/ETXMEM...)                               */
/* -> emulate a virtual file system: Once added the voices   */
/*    (and variants) can but used refered by their name      */
/*************************************************************/


/**
* Select whehther allocation is performed in EXTMEM (if present) or in regular DMAMEM (default choice)
* The library require around 130Kb of dynamic memory for normal usage. 
* 
* alloc_in_EXTMEM = 0: use DMAMEM (default choice)
*                 = 1: use EXTMEM (if present)
**/
#ifdef __cplusplus
extern "C"
#endif
void espeak_SetMemoryLocation(int alloc_in_EXTMEM);
...
extern "C"
#endif
int espeak_GetMemoryLocation(); 


/**
* Return the number of byte of dynamic memory 
...
/**
* Return maximum number of byte of dynamic memory
* used by the library so far. 
**/
#ifdef __cplusplus
extern "C"
#endif
...
* Return 0 (EE_OK) on success or negative value on error.
*
* Example:
* 
* #include "espeak-ng-data/fr_dict.h"   // <- contain the array espeak_ng_data_fr_dict
* ...
...
extern "C"
#endif
int espeak_RegisterDict(const char* language_name, const unsigned char* dict_data, int dict_data_len);


/**
* Register a language voice
* Return 0 (EE_OK) on success or negative value on error.
*
* Example: 
*
* #include "espeak-ng-data/lang/roa/fr.h"   // <- contain the array espeak_ng_data_lang_roa_fr
* ...
...
extern "C"
#endif
int espeak_RegisterLang(const char* voice_name, const unsigned char* voice_data, int voice_data_len);


/**
* Register a voice variant
* Return 0 (EE_OK) on success or negative value on error.
*
* Example:
*
* #include "espeak-ng-data/voices/!v/Alicia.h"   // <- contain the array espeak_ng_data_voices__v_Alicia
* ...
...
extern "C"
#endif
int espeak_RegisterVoiceVariant(const char* variant_name, const unsigned char* variant_data, int variant_data_len);


/**
* Register all the voice variants at once. 
* 
* Takes around 50kB of FLASH memory (require no RAM)
**/
#ifdef __cplusplus
extern "C"
#endif
...
extern "C"
#endif
ESPEAK_API void espeak_SetPhonemeTrace(int phonememode, MY_FILE *stream);
...
extern "C"
#endif
ESPEAK_API void espeak_CompileDictionary(const char *path, MY_FILE *log, int flags);
/* Compile pronunciation dictionary for a language which corresponds to the currently
   ...
   log:   Stream for error reports and statistics information. If log=NULL then my_stderr will be used.
