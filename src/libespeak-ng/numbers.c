...
PROGMEM static const ACCENTS accents_tab[] = {
	{ "_lig", 1 },
	{ "_smc", 0 },  // smallcap
	{ "_tur", 0 },  // turned
	{ "_rev", 0 },  // reversed
...
PROGMEM static const short non_ascii_tab[] = {
	0,
...
PROGMEM static const unsigned short letter_accents_0e0[] = {
...
PROGMEM static const unsigned short letter_accents_250[] = {
...
FLASHMEM static int LookupLetter2(Translator *tr, unsigned int letter, char *ph_buf)
{
	int len;
...
FLASHMEM void LookupAccentedLetter(Translator *tr, unsigned int letter, char *ph_buf)
{
...
FLASHMEM void LookupLetter(Translator *tr, unsigned int letter, int next_byte, char *ph_buf1, int control)
{
...
PROGMEM static const unsigned short derived_letters[] = {
	0x00aa, 'a'+L_SUP,
	0x00b2, '2'+L_SUP,
	0x00b3, '3'+L_SUP,
	0x00b9, '1'+L_SUP,
...
FLASHMEM int IsSuperscript(int letter)
{
...
FLASHMEM void SetSpellingStress(Translator *tr, char *phonemes, int control, int n_chars)
{
...
FLASHMEM static int CheckDotOrdinal(Translator *tr, char *word, char *word_end, WORD_TAB *wtab, int roman)
{
	int ordinal = 0;
	int c2;
	int nextflags;
...
FLASHMEM static int hu_number_e(const char *word, int thousandplex, int value)
{
...
FLASHMEM int TranslateRoman(Translator *tr, char *word, char *ph_out, WORD_TAB *wtab)
{
	int c;
	char *p;
	const char *p2;
	...
	PROGMEM static const int roman_values[] = { 1, 10, 100, 1000, 5, 50, 500 };
...
FLASHMEM static const char *M_Variant(int value)
{
...
FLASHMEM static int LookupThousands(Translator *tr, int value, int thousandplex, int thousands_exact, char *ph_out)
{
...
FLASHMEM static int LookupNum2(Translator *tr, int value, int thousandplex, const int control, char *ph_out)
{
...
FLASHMEM static int LookupNum3(Translator *tr, int value, char *ph_out, bool suppress_null, int thousandplex, int control)
{
...
FLASHMEM static bool CheckThousandsGroup(char *word, int group_len)
{
...
FLASHMEM static int TranslateNumber_1(Translator *tr, char *word, char *ph_out, unsigned int *flags, WORD_TAB *wtab, int control)
{
...
FLASHMEM int TranslateNumber(Translator *tr, char *word1, char *ph_out, unsigned int *flags, WORD_TAB *wtab, int control)
{
