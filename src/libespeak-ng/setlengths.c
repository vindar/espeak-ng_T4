...
PROGMEM static unsigned char speed_lookup[] = {
...
PROGMEM static unsigned char pause_factor_350[] = {
...
PROGMEM static unsigned char wav_factor_350[] = {
...
FLASHMEM void SetSpeed(int control)
{
	int x;
	int wpm;
...
FLASHMEM static void SetSpeedMultiplier(int *x, int *wpm) {
	int wpm2;
...
FLASHMEM static void SetSpeedFactors(voice_t *voice, int x, int *speed1, int *speed2, int *speed3) {
...
FLASHMEM static void SetSpeedMods(SPEED_FACTORS *speed, int voiceSpeedF1, int wpm, int x) {
...
FLASHMEM espeak_ng_STATUS SetParameter(int parameter, int value, int relative)
{
...
FLASHMEM static void DoEmbedded2(int *embix)
{
...
FLASHMEM void CalcLengths(Translator *tr)
{
	int ix;
	int ix2;
	PHONEME_LIST *prev;
	...
	for (ix = 1; ix < n_phoneme_list; ix++) {
		...
		case phVOWEL:
			...
			if (p->env >= (N_ENVELOPE_DATA-1)) {
				my_fprintf(my_stderr, "espeak: Bad intonation data\n");
				p->env = 0;
			}
...
PROGMEM static unsigned char length_mods_en[100] = {
...
PROGMEM static unsigned char length_mods_en0[100] = {
//	a    ,    t    s    n    d    z    r    N    <- next
...
PROGMEM static unsigned char length_mods_equal[100] = {
//	a    ,    t    s    n    d    z    r    N    <- next
...
PROGMEM static unsigned char *length_mod_tabs[6] = {
	length_mods_en,
	length_mods_en,    // 1
	length_mods_en0,   // 2
	length_mods_equal, // 3
...
FLASHMEM void SetLengthMods(Translator *tr, int value)
{
	int value2;
