...
PROGMEM const ALPHABET alphabets[] = {
...
FLASHMEM const ALPHABET *AlphabetFromChar(int c)
{
...
FLASHMEM static void Translator_Russian(Translator *tr);

FLASHMEM static void SetLetterVowel(Translator *tr, int c)
{
	tr->letter_bits[c] = (tr->letter_bits[c] & 0x40) | 0x81; // keep value for group 6 (front vowels e,i,y)
}

FLASHMEM static void ResetLetterBits(Translator *tr, int groups)
{
...
FLASHMEM static void SetLetterBits(Translator *tr, int group, const char *string)
{
	int bits;
	unsigned char c;
...
FLASHMEM static void SetLetterBitsRange(Translator *tr, int group, int first, int last)
{
	int bits;
	int ix;
...
FLASHMEM static void SetLetterBitsUTF8(Translator *tr, int group, const char *letters, int offset)
{
...
PROGMEM static const unsigned short chars_ignore_default[] = {
	// U+00AD SOFT HYPHEN
...
PROGMEM static const unsigned short chars_ignore_zwnj_hyphen[] = {
	// U+00AD SOFT HYPHEN
	//     Used to mark hyphenation points in words for where to split a
	//     word at the end of a line to provide readable justified text.
	0xad,   1,
...
PROGMEM const unsigned char utf8_ordinal[] = { 0xc2, 0xba, 0 }; // masculine ordinal character, UTF-8
PROGMEM const unsigned char utf8_null[] = { 0 }; // null string, UTF-8

FLASHMEM static Translator *NewTranslator(void)
{
	Translator *tr;
	int ix;
	PROGMEM static const unsigned char stress_amps2[] = { 18, 18, 20, 20, 20, 22, 22, 20 };
	PROGMEM static const short stress_lengths2[8] = { 182, 140, 220, 220, 220, 240, 260, 280 };
	PROGMEM static const wchar_t empty_wstring[1] = { 0 };
	PROGMEM static const wchar_t punct_in_word[2] = { '\'', 0 };  // allow hyphen within words
	PROGMEM static const unsigned char default_tunes[6] = { 0, 1, 2, 3, 0, 0 };
	...
	PROGMEM static const char transpose_map_latin[] = {
	...
	if ((tr = (Translator *)my_malloc(sizeof(Translator))) == NULL)
		return NULL;
...
PROGMEM static const short pairs_ru[] = {
...
PROGMEM static const unsigned char ru_vowels[] = { // (also kazakh) offset by 0x420 -- а е ё и о у ы э ю я ә ө ұ ү і
	0x10, 0x15, 0x31, 0x18, 0x1e, 0x23, 0x2b, 0x2d, 0x2e, 0x2f,  0xb9, 0xc9, 0x91, 0x8f, 0x36, 0
};
PROGMEM static const unsigned char ru_consonants[] = { // б в г д ж з й к л м н п р с т ф х ц ч ш щ ъ ь қ ң һ
...
FLASHMEM static void SetArabicLetters(Translator *tr)
{
	PROGMEM static const char * const arab_vowel_letters = "َ  ُ  ِ";
	PROGMEM static const char * const arab_consonant_vowel_letters = "ا و ي";
	PROGMEM static const char * const arab_consonant_letters = "ب پ ت ة ث ج ح خ د ذ ر ز س ش ص ض ط ظ ع غ ف ق ك ل م ن ئ ؤ ء أ آ إ ه";
	PROGMEM static const char * const arab_thick_letters = "ص ض ط ظ";
	PROGMEM static const char * const arab_shadda_letter = " ّ ";
	PROGMEM static const char * const arab_hamza_letter = " ّ ";
	PROGMEM static const char * const arab_sukun_letter = " ّ ";
...
FLASHMEM static void SetCyrillicLetters(Translator *tr)
{
	...
	PROGMEM static const char cyrl_soft[] = { 0x2c, 0x19, 0x27, 0x29, 0 }; // letter group B  [k ts; s;] -- ь й ч щ
	PROGMEM static const char cyrl_hard[] = { 0x2a, 0x16, 0x26, 0x28, 0 }; // letter group H  [S Z ts] -- ъ ж ц ш
	PROGMEM static const char cyrl_nothard[] = { 0x11, 0x12, 0x13, 0x14, 0x17, 0x19, 0x1a, 0x1b, 0x1c, 0x1d, 0x1f, 0x20, 0x21, 0x22, 0x24, 0x25, 0x27, 0x29, 0x2c, 0 }; // б в г д з й к л м н п р с т ф х ч щ ь
	PROGMEM static const char cyrl_voiced[] = { 0x11, 0x12, 0x13, 0x14, 0x16, 0x17, 0 };    // letter group G  (voiced obstruents) -- б в г д ж з
	PROGMEM static const char cyrl_ivowels[] = { 0x2c, 0x2e, 0x2f, 0x31, 0 };   // letter group Y  (iotated vowels & soft-sign) -- ь ю я ё
...
FLASHMEM void SetIndicLetters(Translator *tr)
{
	// Set letter types for Devanagari (Indic) script languages: Devanagari, Tamill, etc.

	PROGMEM static const char deva_consonants2[] = { 0x02, 0x03, 0x58, 0x59, 0x5a, 0x5b, 0x5c, 0x5d, 0x5e, 0x5f, 0x7b, 0x7c, 0x7e, 0x7f, 0 };
	PROGMEM static const char deva_vowels2[] = { 0x60, 0x61, 0x55, 0x56, 0x57, 0x62, 0x63, 0 };  // non-consecutive vowels and vowel-signs
...
FLASHMEM static void SetupTranslator(Translator *tr, const short *lengths, const unsigned char *amps)
{
	if (lengths != NULL)
...
FLASHMEM Translator *SelectTranslator(const char *name)
{
	int name2 = 0;
	Translator *tr;

	PROGMEM static const short stress_lengths_equal[8] = { 230, 230,  230, 230,  0, 0,  230, 230 };
	PROGMEM static const unsigned char stress_amps_equal[8] = { 19, 19, 19, 19, 19, 19, 19, 19 };

	PROGMEM static const short stress_lengths_fr[8] = { 190, 170,  190, 200,  0, 0,  190, 240 };
	PROGMEM static const unsigned char stress_amps_fr[8] = { 18, 16, 18, 18, 18, 18, 18, 18 };

	PROGMEM static const unsigned char stress_amps_sk[8] = { 17, 16, 20, 20, 20, 22, 22, 21 };
	PROGMEM static const short stress_lengths_sk[8] = { 190, 190, 210, 210, 0, 0, 210, 210 };

	PROGMEM static const short stress_lengths_ta[8] = { 200, 200,  210, 210,  0, 0,  230, 230 };
	PROGMEM static const short stress_lengths_ta2[8] = { 230, 230,  240, 240,  0, 0,  260, 260 };
	PROGMEM static const unsigned char stress_amps_ta[8] = { 18, 18, 18, 18, 20, 20, 22, 22 };
	...
	case L('a', 'f'):
	{
	PROGMEM static const short stress_lengths_af[8] = { 170, 140, 220, 220,  0, 0, 250, 270 };
	...
	{
	PROGMEM static const unsigned char stress_amps_be[8] = { 12, 10, 8, 8, 0, 0, 16, 17 };
	PROGMEM static const short stress_lengths_be[8] = { 160, 140, 200, 140, 0, 0, 240, 160 };
	PROGMEM static const wchar_t vowels_be[] = { // offset by 0x420 -- а е ё о у ы э ю я і
			0x10, 0x15, 0x31, 0x1e, 0x23, 0x2b, 0x2d, 0x2e, 0x2f, 0x36, 0
		};
	PROGMEM static const unsigned char consonants_be[] = { // б в г д ж з й к л м н п р с т ф х ц ч ш ў
	...
	{
	PROGMEM static const short stress_lengths_bn[8] = { 180, 180,  210, 210,  0, 0,  230, 240 };
	PROGMEM static const unsigned char stress_amps_bn[8] = { 18, 18, 18, 18, 20, 20, 22, 22 };
	PROGMEM static const char bn_consonants2[3] = { 0x70, 0x71, 0 };
	...
	case L('c', 'y'): // Welsh
	{
	PROGMEM static const short stress_lengths_cy[8] = { 170, 220, 180, 180, 0, 0, 250, 270 };
	PROGMEM static const unsigned char stress_amps_cy[8] = { 17, 15, 18, 18, 0, 0, 22, 20 }; // 'diminished' is used to mark a quieter, final unstressed syllable
	...
	case L('d', 'a'): // Danish
	{
	PROGMEM static const short stress_lengths_da[8] = { 160, 140, 200, 200, 0, 0, 220, 230 };
	...
	case L('d', 'e'):
	{
	PROGMEM static const short stress_lengths_de[8] = { 150, 130, 200, 200,  0, 0, 270, 270 };
	PROGMEM static const unsigned char stress_amps_de[] = { 20, 20, 20, 20, 20, 22, 22, 20 };
	...
	case L('e', 'n'):
	{
	PROGMEM static const short stress_lengths_en[8] = { 182, 140, 220, 220, 0, 0, 248, 275 };
	...
	{
	PROGMEM static const short stress_lengths_el[8] = { 155, 180,  210, 210,  0, 0,  270, 300 };
	PROGMEM static const unsigned char stress_amps_el[8] = { 15, 12, 20, 20, 20, 22, 22, 21 }; // 'diminished' is used to mark a quieter, final unstressed syllable

		// character codes offset by 0x380
	PROGMEM static const char el_vowels[] = { 0x10, 0x2c, 0x2d, 0x2e, 0x2f, 0x30, 0x31, 0x35, 0x37, 0x39, 0x3f, 0x45, 0x49, 0x4a, 0x4b, 0x4c, 0x4d, 0x4e, 0x4f, 0 };
	PROGMEM static const char el_fvowels[] = { 0x2d, 0x2e, 0x2f, 0x35, 0x37, 0x39, 0x45, 0x4d, 0 }; // ε η ι υ  έ ή ί ύ _
	PROGMEM static const char el_voiceless[] = { 0x38, 0x3a, 0x3e, 0x40, 0x42, 0x43, 0x44, 0x46, 0x47, 0 }; // θ κ ξ π ς σ τ φ χ _
	PROGMEM static const char el_consonants[] = { 0x32, 0x33, 0x34, 0x36, 0x38, 0x3a, 0x3b, 0x3c, 0x3d, 0x3e, 0x40, 0x41, 0x42, 0x43, 0x44, 0x46, 0x47, 0x48, 0 };
	PROGMEM static const wchar_t el_char_apostrophe[] = { 0x3c3, 0 }; // σ _
	...
	case L('e', 'o'):
	{
	PROGMEM static const short stress_lengths_eo[8] = { 150, 140,  180, 180,    0,   0,  200, 200 };
	PROGMEM static const unsigned char stress_amps_eo[] = { 16, 14, 20, 20, 20, 22, 22, 21 };
	PROGMEM static const wchar_t eo_char_apostrophe[2] = { 'l', 0 };
	...
	{
	PROGMEM static const short stress_lengths_es[8] = { 160, 145,  155, 150,  0, 0,  200, 245 };
	PROGMEM static const unsigned char stress_amps_es[8] = { 16, 14, 15, 16, 20, 20, 22, 22 }; // 'diminished' is used to mark a quieter, final unstressed syllable
	PROGMEM static const wchar_t ca_punct_within_word[] = { '\'', 0xb7, 0 }; // ca: allow middle-dot within word
	...
	case L('e', 'u'): // basque
	{
	PROGMEM static const short stress_lengths_eu[8] = { 200, 200,  200, 200,  0, 0,  210, 230 }; // very weak stress
	PROGMEM static const unsigned char stress_amps_eu[8] = { 16, 16, 18, 18, 18, 18, 18, 18 };
	...
	PROGMEM static const char transpose_map_fa[] = {
	...
	case L('m', 'r'): // Marathi
	{
	PROGMEM static const short stress_lengths_hi[8] = { 190, 190,  210, 210,  0, 0,  230, 250 };
	PROGMEM static const unsigned char stress_amps_hi[8] = { 17, 14, 20, 19, 20, 22, 22, 21 };
	...
	case L('s', 'r'): // Serbian
	{
	PROGMEM static const unsigned char stress_amps_hr[8] = { 17, 17, 20, 20, 20, 22, 22, 21 };
	PROGMEM static const short stress_lengths_hr[8] = { 180, 160, 200, 200, 0, 0, 220, 230 };
	PROGMEM static const short stress_lengths_sr[8] = { 160, 150, 200, 200, 0, 0, 250, 260 };
	...
	{
	PROGMEM static const unsigned char stress_amps_hu[8] = { 17, 17, 19, 19, 20, 22, 22, 21 };
	PROGMEM static const short stress_lengths_hu[8] = { 185, 195, 195, 190, 0, 0, 210, 220 };
	...
	case L('h', 'y'): // Armenian
	{
	PROGMEM static const short stress_lengths_hy[8] = { 250, 200,  250, 250,  0, 0,  250, 250 };
	PROGMEM static const char hy_vowels[] = { 0x31, 0x35, 0x37, 0x38, 0x3b, 0x48, 0x55, 0 };
	PROGMEM static const char hy_consonants[] = {
	...
	PROGMEM static const char hy_consonants2[] = { 0x45, 0 };
	...
	case L('m', 's'): // Malay
	{
	PROGMEM static const short stress_lengths_id[8] = { 160, 200,  180, 180,  0, 0,  220, 240 };
	PROGMEM static const unsigned char stress_amps_id[8] = { 16, 18, 18, 18, 20, 22, 22, 21 };
	...
	{
	PROGMEM static const short stress_lengths_is[8] = { 180, 160, 200, 200, 0, 0, 240, 250 };
	PROGMEM static const wchar_t is_lettergroup_B[] = { 'c', 'f', 'h', 'k', 'p', 't', 'x', 0xfe, 0 }; // voiceless conants, including 'þ'  ?? 's'
	...
	case L('i', 't'): // Italian
	{
	PROGMEM static const short stress_lengths_it[8] = { 160, 140, 150, 165, 0, 0, 218, 305 };
	PROGMEM static const unsigned char stress_amps_it[8] = { 17, 15, 18, 16, 20, 22, 22, 22 };
	...
	{
	PROGMEM static const short stress_lengths_jbo[8] = { 145, 145, 170, 160, 0, 0, 330, 350 };
	PROGMEM static const wchar_t jbo_punct_within_word[] = { '.', ',', '\'', 0x2c8, 0 }; // allow period and comma within a word, also stress marker (from LOPT_CAPS_IN_WORD)
	...
	PROGMEM static const char ka_vowels[] = { 0x30, 0x34, 0x38, 0x3d, 0x43, 0x55, 0x57, 0 };
	PROGMEM static const char ka_consonants[] =
	...
	case L('k', 'k'): // Kazakh
	{
	PROGMEM static const unsigned char stress_amps_tr[8] = { 18, 16, 20, 21, 20, 21, 21, 20 };
	PROGMEM static const short stress_lengths_tr[8] = { 190, 180, 230, 230, 0, 0, 250, 250 };
	...
	{
	PROGMEM static const char ko_ivowels[] = { 0x63, 0x64, 0x67, 0x68, 0x6d, 0x72, 0x74, 0x75, 0 }; // y and i vowels
	PROGMEM static const unsigned char ko_voiced[] = { 0x02, 0x05, 0x06, 0xab, 0xaf, 0xb7, 0xbc, 0 }; // voiced consonants, l,m,n,N
	...
	case L('k', 'u'): // Kurdish
	{
	PROGMEM static const unsigned char stress_amps_ku[8] = { 18, 18, 20, 20, 20, 22, 22, 21 };
	PROGMEM static const short stress_lengths_ku[8] = { 180, 180, 190, 180, 0, 0, 230, 240 };
	...
	{
	PROGMEM static const unsigned char stress_amps_lv[8] = { 14, 10, 10, 8, 0, 0, 20, 15 };
	PROGMEM static const short stress_lengths_lv[8] = { 180, 180, 180, 160, 0, 0, 230, 180 };
	...
	{
	PROGMEM static const wchar_t vowels_cyrillic[] = {
			// also include 'р' [R]
			0x440, 0x430, 0x435, 0x438, 0x439, 0x43e, 0x443, 0x44b, 0x44d,
			0x44e, 0x44f, 0x450, 0x451, 0x456, 0x457, 0x45d, 0x45e, 0
		};
	PROGMEM static const unsigned char stress_amps_mk[8] = { 17, 17, 20, 20, 20, 22, 22, 21 };
	PROGMEM static const short stress_lengths_mk[8] = { 180, 160, 200, 200, 0, 0, 220, 230 };
	...
	case L('n', 'l'): // Dutch
	{
	PROGMEM static const short stress_lengths_nl[8] = { 160, 135, 210, 210,  0, 0, 260, 280 };
	...
	{
	PROGMEM static const short stress_lengths_no[8] = { 160, 140, 200, 200, 0, 0, 220, 230 };
	...
	case L('o', 'm'): // Oromo
	{
	PROGMEM static const unsigned char stress_amps_om[] = { 18, 15, 20, 20, 20, 22, 22, 22 };
	PROGMEM static const short stress_lengths_om[8] = { 200, 200, 200, 200, 0, 0, 200, 200 };
	...
	case L('p', 'l'): // Polish
	{
	PROGMEM static const short stress_lengths_pl[8] = { 160, 190,  175, 175,  0, 0,  200, 210 };
	PROGMEM static const unsigned char stress_amps_pl[8] = { 17, 13, 19, 19, 20, 22, 22, 21 }; // 'diminished' is used to mark a quieter, final unstressed syllable
	...
	{
	PROGMEM static const short stress_lengths_pt[8] = { 170, 115,  210, 240,  0, 0,  260, 280 };
	PROGMEM static const unsigned char stress_amps_pt[8] = { 16, 11, 19, 21, 20, 22, 22, 21 }; // 'diminished' is used to mark a quieter, final unstressed syllable
	...
	case L('r', 'o'): // Romanian
	{
	PROGMEM static const short stress_lengths_ro[8] = { 170, 170,  180, 180,  0, 0,  240, 260 };
	PROGMEM static const unsigned char stress_amps_ro[8] = { 15, 13, 18, 18, 20, 22, 22, 21 };
	...
	{
	PROGMEM static const unsigned char stress_amps_fi[8] = { 18, 16, 22, 22, 20, 22, 22, 22 };
	PROGMEM static const short stress_lengths_fi[8] = { 150, 180, 200, 200, 0, 0, 210, 250 };
	...
	case L('s', 'q'): // Albanian
	{
	PROGMEM static const short stress_lengths_sq[8] = { 150, 150,  180, 180,  0, 0,  300, 300 };
	PROGMEM static const unsigned char stress_amps_sq[8] = { 16, 12, 16, 16, 20, 20, 21, 19 };
	...
	case L('s', 'v'): // Swedish
	{
	PROGMEM static const unsigned char stress_amps_sv[] = { 16, 16, 20, 20, 20, 22, 22, 21 };
	PROGMEM static const short stress_lengths_sv[8] = { 160, 135, 220, 220, 0, 0, 250, 280 };
	...
	case L('t', 'n'): // Setswana
	{
	PROGMEM static const short stress_lengths_sw[8] = { 160, 170,  200, 200,    0,   0,  320, 340 };
	PROGMEM static const unsigned char stress_amps_sw[] = { 16, 12, 19, 19, 20, 22, 22, 21 };
	...
	case L('t', 'e'): // Telugu
	{
		...
		if (name2 == L('t', 'a')) {
			...
			PROGMEM static const short stress_lengths_ml[8] = { 180, 160,  240, 240,  0, 0,  260, 260 };
	...
	{
	PROGMEM static const unsigned char stress_amps_tr[8] = { 18, 16, 20, 21, 20, 21, 21, 20 };
	PROGMEM static const short stress_lengths_tr[8] = { 190, 180, 200, 230, 0, 0, 240, 250 };
	...
	{
	PROGMEM static const short stress_lengths_vi[8] = { 150, 150,  180, 180,  210, 230,  230, 240 };
	PROGMEM static const unsigned char stress_amps_vi[] = { 16, 16, 16, 16, 22, 22, 22, 22 };
	PROGMEM static const wchar_t vowels_vi[] = {
	...
	{
	PROGMEM static const short stress_lengths_zh[8] = { 230, 150, 230, 230, 230, 0, 240, 250 }; // 1=tone5. end-of-sentence, 6=tone 1&4, 7=tone 2&3
	PROGMEM static const unsigned char stress_amps_zh[] = { 22, 16, 22, 22, 22, 22, 22, 22 };
...
FLASHMEM void ProcessLanguageOptions(LANGUAGE_OPTIONS *langopts)
{
...
FLASHMEM static void Translator_Russian(Translator *tr)
{
	PROGMEM static const unsigned char stress_amps_ru[] = { 16, 16, 18, 18, 20, 24, 24, 22 };
	PROGMEM static const short stress_lengths_ru[8] = { 150, 140, 220, 220, 0, 0, 260, 280 };
	PROGMEM static const char ru_ivowels[] = { 0x15, 0x18, 0x34, 0x37, 0 }; // add "е и є ї" to Y lettergroup (iotated vowels & soft-sign)
