...
FLASHMEM int TranslateWord3(Translator *tr, char *word_start, WORD_TAB *wtab, char *word_out, bool *any_stressed_words, ALPHABET *current_alphabet, char word_phonemes[], size_t size_word_phonemes)
{
	...
	char *wordx;
#if ESPEAK_STACK_HACK
	TranslateWord3Tables *tables = my_calloc(1, sizeof(TranslateWord3Tables));
	assert(tables!=NULL);
...
FLASHMEM void ApplySpecialAttribute2(Translator *tr, char *phonemes, int dict_flags)
{
...
FLASHMEM static void ChangeWordStress(Translator *tr, char *word, int new_stress)
{
	int ix;
	unsigned char *p;
	int max_stress;
...
FLASHMEM static char *SpeakIndividualLetters(Translator *tr, char *word, char *phonemes, int spell_word, const ALPHABET *current_alphabet, char word_phonemes[])
{
	int posn = 0;
	int capitals = 0;
	bool non_initial = false;
...
PROGMEM static const char * const hex_letters[] = {"'e:j",	"b'i:",	"s'i:",	"d'i:",	"'i:",	"'ef"};
PROGMEM static const char * const modifiers[] = { NULL, "_sub", "_sup", NULL };
// unicode ranges for non-ascii digits 0-9 (these must be in ascending order)
PROGMEM static const int number_ranges[] = {
	0x660, 0x6f0, // arabic
...
FLASHMEM static int TranslateLetter(Translator *tr, char *word, char *phonemes, int control, const ALPHABET *current_alphabet)
{
	...
	char ph_alphabet[80];
	char hexbuf[12];
	PROGMEM static const char pause_string[] = { phonPAUSE, 0 };
...
FLASHMEM static void addPluralSuffixes(int flags, Translator *tr, char last_char, char *word_phonemes)
{
...
FLASHMEM static int CheckDottedAbbrev(char *word1)
{
	int wc;
	int count = 0;
	int ix;
...
FLASHMEM static int NonAsciiNumber(int letter)
{
...
FLASHMEM static int Unpronouncable(Translator *tr, char *word, int posn)
{
...
FLASHMEM static int Unpronouncable2(Translator *tr, char *word)
{
	int c;
	int end_flags;
