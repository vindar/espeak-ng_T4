...
PROGMEM unsigned char env_fall[128] = {
...
PROGMEM unsigned char env_rise[128] = {
...
PROGMEM unsigned char env_frise[128] = {
...
PROGMEM static unsigned char env_r_frise[128] = {
...
PROGMEM static unsigned char env_frise2[128] = {
...
PROGMEM static unsigned char env_r_frise2[128] = {
...
PROGMEM static unsigned char env_risefall[128] = {
...
PROGMEM static unsigned char env_rise2[128] = {
...
PROGMEM static unsigned char env_fall2[128] = {
...
PROGMEM static unsigned char env_fallrise3[128] = {
...
PROGMEM static unsigned char env_fallrise4[128] = {
...
PROGMEM static unsigned char env_risefallrise[128] = {
...
PROGMEM unsigned char *envelope_data[N_ENVELOPE_DATA] = {
	env_fall,  env_fall,
	env_rise,  env_rise,
...
// indexed by stress
PROGMEM static int min_drop[] =  { 6, 7, 9, 9, 20, 20, 20, 25 };

// pitch change during the main part of the clause
PROGMEM static int drops_0[8] = { 9, 9, 16, 16, 16, 23, 55, 32 };

// overflow table values are 64ths of the body pitch range (between body_start and body_end)
PROGMEM static signed char oflow[] = { 0, 40, 24, 8, 0 };
PROGMEM static signed char oflow_emf[] = { 10, 52, 32, 20, 10 };
PROGMEM static signed char oflow_less[] = { 6, 38, 24, 14, 4 };
...
PROGMEM static TONE_HEAD tone_head_table[N_TONE_HEAD_TABLE] = {
...
PROGMEM static TONE_NUCLEUS tone_nucleus_table[N_TONE_NUCLEUS_TABLE] = {
...
FLASHMEM static void count_pitch_vowels(SYLLABLE *syllable_tab, int start, int end, int clause_end)
{
	int ix;
	int stress;
	int max_stress = 0;
...
FLASHMEM static int count_increments(SYLLABLE *syllable_tab, int ix, int end_ix, int min_stress)
{
	int count = 0;
	int stress;
...
FLASHMEM static void set_pitch(SYLLABLE *syl, int base, int drop)
{
	int pitch1, pitch2;
	int flags = 0;
...
FLASHMEM static int CountUnstressed(SYLLABLE *syllable_tab, int start, int end, int limit)
{
	int ix;
...
FLASHMEM static int SetHeadIntonation(SYLLABLE *syllable_tab, TUNE *tune, int syl_ix, int end_ix)
{
	int stress;
	SYLLABLE *syl;
	int ix;
...
FLASHMEM static int calc_pitch_segment(SYLLABLE *syllable_tab, int ix, int end_ix, TONE_HEAD *th, TONE_NUCLEUS *tn, int min_stress, bool continuing)
{
	int stress;
	int pitch = 0;
	int increment = 0;
...
FLASHMEM static void SetPitchGradient(SYLLABLE *syllable_tab, int start_ix, int end_ix, int start_pitch, int end_pitch)
{
...
FLASHMEM static int calc_pitches2(SYLLABLE *syllable_tab, int start, int end,  int tune_number)
{
	int ix;
	TUNE *tune;
	int drop;
...
// Calculate pitch values for the vowels in this tone group
FLASHMEM static int calc_pitches(SYLLABLE *syllable_tab, int control, int start, int end,  int tune_number)
{
	int ix;
	TONE_HEAD *th;
	TONE_NUCLEUS *tn;
...
FLASHMEM static void CalcPitches_Tone(Translator *tr)
{
	PHONEME_LIST *p;
	int ix;
...
FLASHMEM void CalcPitches(Translator *tr, int clause_type)
{
	...
	SYLLABLE *syllable_tab = my_calloc(1, sizeof(SYLLABLE)*N_PHONEME_LIST);
