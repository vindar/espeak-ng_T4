...
#define ESPEAKNG_DEFAULT_VOICE "en" // use to be "en" but this created problem when using another language, for some reason...
...
ESPEAK_NG_API espeak_ng_STATUS
espeak_ng_CompileIntonation(MY_FILE *log,
                            espeak_ng_ERROR_CONTEXT *context);
