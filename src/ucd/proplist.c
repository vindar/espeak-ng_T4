...
FLASHMEM static ucd_property properties_Cc(codepoint_t c)
{
...
FLASHMEM static ucd_property properties_Cf(codepoint_t c)
{
	switch (c & 0xFFFFFF00)
	{
	case 0x0000:
...
FLASHMEM static ucd_property properties_Cn(codepoint_t c)
{
	switch (c & 0xFFFFFF00)
	{
	case 0x2000:
...
FLASHMEM static ucd_property properties_Ll(codepoint_t c)
{
	switch (c & 0xFFFFFF00)
	{
	case 0x0000:
...
FLASHMEM static ucd_property properties_Lm(codepoint_t c)
{
	switch (c & 0xFFFFFF00)
	{
	case 0x0200:
...
FLASHMEM static ucd_property properties_Lo(codepoint_t c)
{
	switch (c & 0xFFFFFF00)
	{
	case 0x0000:
...
FLASHMEM static ucd_property properties_Lo_ideographic(codepoint_t c)
{
	switch (c & 0xFFFF0000)
	{
	case 0x000000:
...
FLASHMEM static ucd_property properties_Lu(codepoint_t c)
{
	switch (c & 0xFFFFFF00)
	{
	case 0x0000:
...
FLASHMEM static ucd_property properties_Mc(codepoint_t c)
{
	switch (c & 0xFFFFFF00)
	{
	case 0x0900:
...
FLASHMEM static ucd_property properties_Me(codepoint_t c)
{
	if (c == 0x20E3) return UCD_PROPERTY_EMOJI_COMPONENT;
	return 0;
}

FLASHMEM static ucd_property properties_Mn(codepoint_t c)
{
	switch (c & 0xFFFFFF00)
	{
	case 0x0300:
...
FLASHMEM static ucd_property properties_Nd(codepoint_t c)
{
	switch (c & 0xFFFFFF00)
	{
	case 0x0000:
...
FLASHMEM static ucd_property properties_Nl(codepoint_t c)
{
	switch (c & 0xFFFFFF00)
	{
	case 0x2100:
...
FLASHMEM static ucd_property properties_No(codepoint_t c)
{
	switch (c & 0xFFFFFF00)
	{
	case 0x1300:
...
FLASHMEM static ucd_property properties_Pc(codepoint_t c)
{
	switch (c & 0xFFFFFF00)
	{
	case 0x2000:
...
FLASHMEM static ucd_property properties_Pd(codepoint_t c)
{
	switch (c & 0xFFFFFF00)
	{
	case 0x0000:
...
FLASHMEM static ucd_property properties_Pe(codepoint_t c)
{
	switch (c & 0xFFFFFF00)
	{
	case 0x0000:
...
FLASHMEM static ucd_property properties_Pf(codepoint_t c)
{
	switch (c & 0xFFFFFF00)
	{
	case 0x0000:
...
FLASHMEM static ucd_property properties_Pi(codepoint_t c)
{
	switch (c & 0xFFFFFF00)
	{
	case 0x0000:
...
FLASHMEM static ucd_property properties_Po(codepoint_t c)
{
	switch (c & 0xFFFFFF00)
	{
	case 0x0000:
...
FLASHMEM static ucd_property properties_Ps(codepoint_t c)
{
	switch (c & 0xFFFFFF00)
	{
	case 0x0000:
...
FLASHMEM static ucd_property properties_Sc(codepoint_t c)
{
	switch (c & 0xFFFFFF00)
	{
	case 0x0000:
...
FLASHMEM static ucd_property properties_Sk(codepoint_t c)
{
	switch (c & 0xFFFFFF00)
	{
	case 0x0000:
...
FLASHMEM static ucd_property properties_Sm(codepoint_t c)
{
	switch (c & 0xFFFFFF00)
	{
	case 0x0000:
...
FLASHMEM static ucd_property properties_So_002600(codepoint_t c)
{
	switch (c & 0xFFFFFFF0)
	{
	case 0x2600:
...
FLASHMEM static ucd_property properties_So_002700(codepoint_t c)
{
	switch (c & 0xFFFFFFF0)
	{
	case 0x2700:
...
FLASHMEM static ucd_property properties_So(codepoint_t c)
{
	switch (c & 0xFFFFFF00)
	{
	case 0x0000:
...
FLASHMEM static ucd_property properties_Zs(codepoint_t c)
{
	if (c == 0x0020) return UCD_PROPERTY_WHITE_SPACE | UCD_PROPERTY_PATTERN_WHITE_SPACE;
	return UCD_PROPERTY_WHITE_SPACE;
}

FLASHMEM ucd_property ucd_properties(codepoint_t c, ucd_category category)
{
	switch (category)
	{
